...
export const workExperience: ExperienceListItem[] = [
  {
    ...
    skills: ["Go", "React", "Tanstack", "Docker", "Nginx", "Nats", "Figma"],
    additionalInfo: [
      "Wrote an OpenADR 2.0b compliant VEN client microservice in Go",
      "Forked xgen to accurately parse the OpenADR xml schema",
      "Designed the webapp for configuring and managing VEN client data",
      "Made the aforementioned webapp using React + TanStack Router & Query",
      "Deployed the microservice with Docker + Nginx",
      "Integrated with the other EdgeX apps via NATS messaging bus",
      "Developed an internal tool in Go for managing stacked PRs",
