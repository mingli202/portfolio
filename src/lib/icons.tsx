  ...
  return (
    <Svg viewBox="0 0 128 128" title="Next.js" {...props}>
      ...
      <path
        ...
        className="fill-background group-hover:fill-[url(#nextjs-gradient-a)]"
      ></path>
      <path
        className="fill-background group-hover:fill-[url(#nextjs-gradient-b)]"
...
export function TailwindCss(props: Props) {
  return (
...
export function Angular(props: Props) {
  return (
    <Svg viewBox="0 0 128 128" title="Angular" {...props}>
      <path d="M 55.296875 69.324219 L 72.703125 69.324219 L 64 48.382812 Z M 55.296875 69.324219 M 64 15.359375 L 16.332031 32.359375 L 23.601562 95.386719 L 64 117.761719 L 104.398438 95.386719 L 111.667969 32.359375 Z M 93.746094 93.492188 L 82.636719 93.492188 L 76.644531 78.539062 L 51.355469 78.539062 L 45.363281 93.492188 L 34.253906 93.492188 L 64 26.675781 Z M 93.746094 93.492188 "></path>
    </Svg>
  );
}

export function React(props: Props) {
  return (
...
export function Rust(props: Props) {
  return (
...
export function ArrowAngularTopRight(props: Props) {
  return (
    <Svg title="Website" {...props}>
...
export function Docker(props: Props) {
  return (
    <Svg title="Docker" viewBox="0 0 128 128" {...props}>
...
export function Firebase(props: Props) {
  return (
...
export function CSharp(props: Props) {
  return (
...
export function Azure(props: Props) {
  return (
...
export function DotNet(props: Props) {
  return (
...
export function FastApi(props: Props) {
  return (
...
export function Numpy(props: Props) {
  return (
...
export function Pandas(props: Props) {
  return (
...
export function Htmx(props: Props) {
  return (
...
export function CSS(props: Props) {
  return (
...
export function Cargo(props: Props) {
  return (
...
export function Supabase(props: Props) {
  return (
...
export function Auth0(props: Props) {
  return (
...
export function Zod(props: Props) {
  return (
...
export function GCP(props: Props) {
  return (
...
export function PowerShell(props: Props) {
  return (
