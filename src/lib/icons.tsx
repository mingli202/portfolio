...
function icon(
  path: JSX.Element,
  { className: initialClassName, ...initialProps }: Props = {},
) {
  function Icon({ className, title, ...props }: Props) {
    return (
      <div title={title ?? initialProps?.title}>
        <svg
          viewBox="0 0 24 24"
...
const GCP = icon(
  ...
  { viewBox: "0 0 128 128", title: "Google Cloud Platform" },
);

const PowerShell = icon(
  <>
    <linearGradient
  ...
  { viewBox: "0 0 128 128", title: "PowerShell" },
);
