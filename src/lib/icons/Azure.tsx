...
export function Azure(props: SvgProps) {
  ...
  return (
    <Svg viewBox="0 0 128 128" title="Azure" {...props}>
      <defs>
        <linearGradient
          id={`azure-original-a-${random.current}`}
          x1="60.919"
          y1="9.602"
          x2="18.667"
          y2="134.423"
        ...
        <linearGradient
          id={`azure-original-b-${random.current}`}
          x1="74.117"
          y1="67.772"
          x2="64.344"
          y2="71.076"
        ...
        <linearGradient
          id={`azure-original-c-${random.current}`}
          x1="68.742"
          y1="5.961"
          x2="115.122"
          y2="129.525"
      ...
      <motion.path
        ...
        fill={`url(#azure-original-a-${random.current})`}
      />
      <motion.path
      ...
      <motion.path
        ...
        transform="translate(.587 4.468) scale(.91904)"
        fill={`url(#azure-original-b-${random.current})`}
      />
      <motion.path
        ...
        transform="translate(.587 4.468) scale(.91904)"
        fill={`url(#azure-original-c-${random.current})`}
      />
    </Svg>
  );
}
