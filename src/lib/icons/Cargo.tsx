  ...
  return (
    <Svg viewBox="0 0 32 32" title="Cargo" {...props}>
      ...
      <motion.path
        ...
        strokeMiterlimit={10}
        strokeWidth="0.054070758972961416"
      />
      {/* Inlined former <use xlink:href="#a"> */}
      <motion.polygon
        variants={hoverVariantBuilder(
          { fill: "var(--background-color)" },
          { fill: "#231f20" },
