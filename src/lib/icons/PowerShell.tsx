...
export function PowerShell(props: SvgProps) {
  ...
  return (
    <Svg viewBox="0 0 128 128" title="PowerShell" {...props}>
      <linearGradient
        id={`powershell-gradient-a-${random.current}`}
        x1="96.306"
        x2="25.454"
        y1="35.144"
        y2="98.431"
      ...
      <path
        fill={`url(#powershell-gradient-a-${random.current})`}
        fillRule="evenodd"
      ...
      ></path>
      <linearGradient
        id={`powershell-gradient-b-${random.current}`}
        x1="25.336"
        x2="94.569"
        y1="98.33"
        y2="36.847"
      ...
      <path
        fill={`url(#powershell-gradient-b-${random.current})`}
        fillRule="evenodd"
