...
export function Python(props: SvgProps) {
  ...
  return (
    <Svg viewBox="0 0 128 128" title="Python" {...props}>
      <linearGradient
        id={`python-original-a-${random.current}`}
      ...
      <linearGradient
        id={`python-original-b-${random.current}`}
        gradientUnits="userSpaceOnUse"
        x1="209.474"
        y1="1098.811"
        x2="173.62"
