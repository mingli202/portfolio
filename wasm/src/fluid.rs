...
impl Fluid {
    pub fn new(
        ...
        Fluid {
            u: vec![vec![0.0; min_squares]; min_squares],
            v: vec![vec![0.0; min_squares]; min_squares],
            b: vec![vec![0.0; min_squares]; min_squares],
            s: vec![vec![0.0; min_squares]; min_squares],
